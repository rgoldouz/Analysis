...
int main(){
    ...
    ch ->Add("root://cms-xrd-global.cern.ch///store/user/piedavid/topNanoAOD/v6-1-1/2017/DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8/TopNanoAODv6-1-1_2017/200613_065556/0000/tree_99.root");
