...
if (NumTrueInteraction < 0 || NumTrueInteraction > 75 ) {return 1;}
	...
	else if (type_str == "down") {return data_up_2016[NumTrueInteraction];}
...
if (NumTrueInteraction < 0 || NumTrueInteraction > 100 ) {return 1;}
	...
	else if (type_str == "down") {return data_up_2017[NumTrueInteraction];}
	else {std::cout<<"Error pu string!"<<std::endl; return 1.0;}
}
}
...
if (NumTrueInteraction < 0 || NumTrueInteraction > 100 ) {return 1;}
	...
	else if (type_str == "down") {return data_up_2018[NumTrueInteraction];}
	else {std::cout<<"Error pu string!"<<std::endl; return 1.0;}
}
}
