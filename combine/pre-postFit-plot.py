...
file=ROOT.TFile("postfit_shapes.root","r")
...
#categories=["LFVVecU_2016_llB1_prefit","LFVVecU_2016_llB1_postfit"] 
categories=["ch1_prefit","ch1_postfit","ch2_prefit","ch2_postfit"] 
